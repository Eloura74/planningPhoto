...
function Events() {
  ...
  const handleVote = async () => {
    ...
    try {
      ...
      showToast(
        error.response?.data?.error || "Erreur lors de la proposition",
        "error",
      );
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-6">
          <p style={{ color: "var(--text-secondary)" }}>
            Proposez vos dates disponibles pour les événements. L'admin choisira
            les dates avec le plus de participants.
          </p>
        </div>
